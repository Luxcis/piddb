                ...
                if(pc){
                    ...
                    if (thisRoute.poketypes.hasOwnProperty(thisPoketype)) {
                        ...
                        if (ROUTES[region][routename].pokes.length == 1) {
                            thisRoute.poketypes[thisPoketype].pkmname = pc.name;
                        }
                    }
                }
            }
    ...
    $('#pokemonspercity').DataTable({
        ...
        columns: [
            ...
            { /* 7 (Col 6) */
                ...
                data: "expmin",
                className: 'num',
                render: $.fn.dataTable.render.number(',', '.', 2, '', '经验')
            },
            { /* 8 (Col 7) */
                name: "Max Exp",
                data: "expmax",
    ...
    $('#pokedex').DataTable({
        ...
        columns: [
            ...
            { /* 6 (Col 7) */
                ...
                data: "bexp",
                className: 'num',
                render: $.fn.dataTable.render.number(',', '.', 0, '', ' 经验')
            },
            { /* 7 (Col 8) */
...
var meta = {
    dataVersion: '1.8.0',
    imgSource: 'http://likexia.gitee.io/pokemon/'
};
